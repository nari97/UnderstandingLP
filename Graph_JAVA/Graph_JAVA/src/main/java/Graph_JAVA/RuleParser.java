...
//    public ArrayList<ArrayList<Integer>> extract_rule(String rule_str) {
//        String []input_list = rule_str.split(" ");
//        ArrayList<ArrayList<String>> output_list = new ArrayList<>();
//        for(String item : input_list) {
//            if (item.contains("=>"))
//                continue;
//            String splits[] = item.replaceAll().split()
//            num,params = item.strip('()').split('?')
//            output_list.append([int(num), *params.split(',')])
//        }
//        return output_list
//    }
